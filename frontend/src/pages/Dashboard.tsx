        ...
        <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Plus Jakarta Sans', sans-serif", position: 'relative' }}>
            ...
            <main style={{ marginLeft: '224px', flex: 1, padding: '2rem', overflowY: 'auto', position: 'relative', zIndex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
                    <div>
                        ...
                        <p style={{ color: '#64748B', fontSize: '0.875rem', margin: '0.25rem 0 0' }}>
                            Overview of your implant planning cases
                        </p>
                    </div>
                    <button
                    ...
                    {[
                        ...
                        <div key={stat.label} style={{
                            ...
                            <p style={{
                                ...
                                textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 0.75rem'
                            }}>
                                {stat.label}
                            </p>
                            <p style={{
                                color: stat.color, fontSize: '2.8rem', fontWeight: 800,
                ...
                <div style={card}>
                    ...
                    {loading ? (
                        <p style={{ color: '#64748B', textAlign: 'center', padding: '2rem 0' }}>Loading...</p>
                    ) : recent.length === 0 ? (
                        <div style={{ textAlign: 'center', padding: '3rem 0' }}>
                            <p style={{ color: '#64748B', marginBottom: '1rem' }}>No cases yet.</p>
                            <button
                                onClick={() => navigate('/upload')}
                                style={{
                                    padding: '0.75rem 1.5rem', borderRadius: '12px', border: 'none',
                            ...
                            {recent.map((c, i) => {
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            display: 'grid', gridTemplateColumns: '1fr 1fr 160px 130px 60px',
                                            padding: '0.875rem 1rem', borderRadius: '10px', alignItems: 'center',
